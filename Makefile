...
TEST_OBJS = $(BUILD_DIR)/simple_processed.o $(BUILD_DIR)/complex_processed.o $(BUILD_DIR)/lucy_tests_processed.o $(BUILD_DIR)/main.o $(BUILD_DIR)/annotations.o $(LUCY_LIB_OBJ)
...
# Build lucy binary
$(LUCY_TARGET): $(LUCY_OBJ) $(LUCY_LIB_OBJ)
	$(CC) $(LUCY_OBJ) $(LUCY_LIB_OBJ) -o $@
